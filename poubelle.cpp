...
void Poubelle::exporterTableauPDF()
{
    ...
    painter.drawText(marginLeft, currentY + 500, "GESTION DES POUBELLES INTELLIGENTES");

    currentY += 1200;
    marginLeft = 200; // Reset margin for table
    ...
    for (int row = 1; row < tableData.size(); row++) {
        ...
        if (currentY + rowHeight > pageHeight - 600) {
            // Dessiner numéro de page avant de changer
